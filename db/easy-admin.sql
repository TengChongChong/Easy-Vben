...
CREATE TABLE `sys_data_source` (
  ...
  `username` varchar(128) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '账号',
...
CREATE TABLE `sys_login_log` (
  ...
  `user_name` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL COMMENT '账号',
