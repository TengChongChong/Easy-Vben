package com.easy.restful.core.aspect;
...
import com.easy.restful.util.http.IpUtil;
...
public class SysLogAspect {
     ...
     * 切点
     */
    @Pointcut("@annotation(com.easy.restful.core.annotation.SysLog)")
    ...
    public void saveSysLog(JoinPoint joinPoint) {
        ...
        // 注解信息
        com.easy.restful.core.annotation.SysLog log = method.getAnnotation(com.easy.restful.core.annotation.SysLog.class);
